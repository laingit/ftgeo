...
Master: <img src="https://api.travis-ci.org/fulcrologic/ftgeo.svg?branch=master"></img>
Develop: <img src="https://api.travis-ci.org/fulcrologic/ftgeo.svg?branch=develop"></img>

## Features

The app supports a fake user database (see `valid-users` in `src/main/ftgeo/api/mutations.clj`)
...
java -Dconfig=config/prod.edn -jar ftgeo.jar
```
