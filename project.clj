(defproject fulcrologic/ftgeo "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds [{:id           "production"
                        ...
                        :compiler     {:asset-path    "js/prod"
                                       :main          ftgeo.client-main
                                       :optimizations :whitespace
                                       :externs       ["externs.js"]
                                       :source-map    "resources/public/js/ftgeo.js.map"
                                       :output-dir    "resources/public/js/prod"
                                       :output-to     "resources/public/js/ftgeo.js"}}]}

  :profiles {:uberjar    {:main           ftgeo.server-main
                          :aot            :all
                          ...
                          :cljsbuild    {:builds
                                         [{:id           "dev"
                                          ...
                                          {:id           "test"
                                           ...
                                           :figwheel     {:on-jsload "ftgeo.client-test-main/client-tests"}
                                           :compiler     {:asset-path    "js/test"
                                                          :main          ftgeo.client-test-main
                                                          :optimizations :none
